...
int main()
{
        ...
        for(int i=0;i<64;i++)
            key1[i]=kp[i]-'0';
    //MENCARI 56 BIT KEY DARI 64 BIT DENGAN PARITY BITS (pc1)
    ...
    //ENKRIPSI DES
         while(round--)
         {
            ...
            r="";
            for(i=0;i<32;i++)
                r+=char(((int(pc[i])-48)^(int(l[i])-48))+48);//XOR2
            l=rtem;
            cout<<"Output Round"<<16-round<<endl;
            string cip="";
            for(i=0;i<32;i+=4)
            {
                int te;
    ...
    while(round--)
    {
        ...
        r=ltem;
        cout<<"Decrypted Output Round"<<16-round<<endl;
        string cip="";
        for(i=0;i<32;i+=4)
        {
            int te;
